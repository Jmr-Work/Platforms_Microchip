...
Overview
----------------------------------------------------------------
This demo shows how to use the microSD click board.  MPLAB(R) 
Code Configurator(MCC) is used to configure the processor, 
...
----------------------------------------------------------------
1) Plug the microSD Click into the appropriate mikroBUS(tm).
